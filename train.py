...
if 1:
    ...
    # Dataset.
    desc += '-asian-fine-tunning-s2000'
    dataset = EasyDict(tfrecord_dir='yellow-real')
    ...
    train.resume_run_id = './model/stylegan-ffhq-1024.pkl'
    train.resume_kimg = 10000 # experimental value
